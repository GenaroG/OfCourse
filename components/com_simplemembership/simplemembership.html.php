...
class HTML_simplemembership {
    ...
    static function ShowUserProfile($user_profile_form, $fields, $profile_image, $joom_user) {
        
        global $database, $my, $Itemid,$mosConfig_absolute_path,$mosConfig_live_site;
        ...
        <ul id="countrytabs_s" class="shadetabs">
            ...
            if(count($MyData) > 1 ){
                ?>
                <li><a href="#" rel="country_s1"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_PROFILE_INFORMATION") ; ?></a></li>
                <?php
            }
            $i=4;
