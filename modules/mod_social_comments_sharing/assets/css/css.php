...
/////////////////////Start for custom blocks\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
  if($params->get('module_style') =='horizontal'){?>
    ...
    .cmp_google_container{
      <?php if($params->get('size_google') == 'small'){
        if($params->get('annotation_google') == 'bubble'){?>
          margin: 0px -20px 0px 0;
      <?php }elseif($params->get('annotation_google') == 'inline'){ ?>
          margin: 0px -263px 0px 0;
      <?php }else{ ?>
          margin: 0px 4px 0px 0;
      <?php }
     }elseif($params->get('size_google') == 'medium'){
          if($params->get('annotation_google') == 'bubble'){?>
      ...
      <?php }else{ ?>
          margin: 0px 4px 0px 0;
      <?php }
      }elseif($params->get('size_google') == 'standard'){
        if($params->get('annotation_google') == 'bubble'){?>
...
/////////////////////Start for GORIZONTAL\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\?>
  ...
  #mainButtons<?php echo $modId; ?> #addthis_icon:hover {
    ...
    #mainButtons<?php echo $modId; ?> a[class^=ig-b-] {
        position: relative;
        top: -7px;
    }
    #mainButtons<?php echo $modId; ?> a[class^=ig-b-] img {
        height: 21px;
    }
