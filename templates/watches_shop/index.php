...
$doc->addScript($this->baseurl."/templates/".$this->template."/javascript/jquery.sticky.js");
...
<?php 
if($this->params->get('expand_prelouder') !== "0" ){
	require_once  ( JPATH_BASE . '/templates/'.$this->template.
		'/prelouder/prelouder_style.inc.php');	
}
?>	
...
if($this->params->get('expand_prelouder') !== "0" ){
	require_once  ( JPATH_BASE . '/templates/'.$this->template.
	'/prelouder/prelouder_script.inc.php');
}
?>	
...
if($this->params->get('expand_prelouder') !== "0" ){
	require_once  (JPATH_BASE . '/templates/'.$this->template.
	 '/prelouder/prelouder_html.inc.php');
}
?>	
	...
	<div class="header">
				...
				<div class="row logo_row">
					...
					<?php if ($this->countModules('Mainmenu')||$this->countModules('VmCart')): ?>
					    <div class="main_menu col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<jdoc:include type="modules" name="VmCart" style="xhtml" />
					    </div>
					<?php endif; ?>
			    <?php endif; ?>
		...
		<div  class="container central_content">
			...
			<div id="globalContent">
			    ...
			    <div class="row">
					<?php if ($left): ?>
					      <div class="sidebar-left col-lg-4 col-md-3 col-sm-3 col-xs-12"><jdoc:include type="modules" name="SidebarLeft" style="xhtml" /></div>
					<?php endif; ?>

						<div id="contentBox" class="<?php if ($left && $right) {print('col-lg-4 col-md-6 col-sm-6 col-xs-12');} else if ($left || $right) {print('col-lg-8 col-md-9 col-sm-9 col-xs-12');} else {print('col-lg-12 col-md-12 col-sm-12 col-xs-12');} ?>">
